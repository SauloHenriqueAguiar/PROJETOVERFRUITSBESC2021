...
labels=['freshapples','freshbanana','freshoranges','rottenapples', 'rottenbanana', 'rottenoranges'] #number of labels should match the number of labels the model was trained with
